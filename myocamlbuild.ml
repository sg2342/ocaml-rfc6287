...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("rfc6287", ["lib"], []); ("testlib", ["tests"], [])];
     lib_c = [];
     flags =
       [
          (["oasis_library_rfc6287_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "A-4-33-40-41-42-43-34-44"])
            ]);
          (["oasis_library_rfc6287_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "A-4-33-40-41-42-43-34-44"])
            ]);
          (["oasis_library_rfc6287_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "A-4-33-40-41-42-43-34-44"])
            ])
       ];
     includes = [("tests", ["lib"])]
